...
public class Main implements ModInitializer {
    ...
    public static final ArmorMaterial Cabbage_ARMOR = (ArmorMaterial) new CabbageArmor();
    ...
    public void onInitialize() {
        ...
        Registry.register(Registry.ITEM, new Identifier(MODID, "cabbage_helmet"), new BaseArmor(Cabbage_ARMOR, EquipmentSlot.HEAD));
        Registry.register(Registry.ITEM, new Identifier(MODID, "cabbage_chestplate"), new BaseArmor(Cabbage_ARMOR, EquipmentSlot.CHEST));
        Registry.register(Registry.ITEM, new Identifier(MODID, "cabbage_leggings"), new BaseArmor(Cabbage_ARMOR, EquipmentSlot.LEGS));
        Registry.register(Registry.ITEM, new Identifier(MODID, "cabbage_boots"), new BaseArmor(Cabbage_ARMOR, EquipmentSlot.FEET));
    }
